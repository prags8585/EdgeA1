...
- NVFP4 needs a recent vLLM (HP notes 0.12+, ideally 0.13). If NVFP4 crashes with `flashinfer_scaled_fp4_mm` or `Failed to run cutlass FP4 gemm on sm120`, fall back to FP8 or BF16.
